...
namespace NaughtyAttributes.Editor
{
    ...
    public class AnimatorParamPropertyDrawer : PropertyDrawerBase
    {
        ...
        private static AnimatorController GetAnimatorController(Animator animator)
        {
            ...
            if (controller is AnimatorOverrideController overrideController) controller = overrideController.runtimeAnimatorController;
        ...
        private static AnimatorController GetAnimatorController(SerializedProperty property, string animatorName)
        {
                ...
                animatorFieldInfo.FieldType == typeof(Animator))
            {
                ...
                if (animator != null)
                {
                    AnimatorController animatorController = GetAnimatorController(animator);
