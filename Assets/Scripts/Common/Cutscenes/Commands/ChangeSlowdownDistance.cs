namespace Common.Cutscenes.Commands
{
    ...
    [Serializable]
    [AddTypeMenu("Character/Change Slowdown Distance")]
    public class ChangeSlowdownDistance : ICinematicCommand
    {
        ...
        [SerializeField] float m_NewSlowdownDistance;

        public bool ShouldWaitEnd => false;

        public void Execute()
        {
            NavigationHelper.Instance.ChangeSlowDownDistance(m_Character.GetComponent<AIPath>(), m_NewSlowdownDistance);
        }
