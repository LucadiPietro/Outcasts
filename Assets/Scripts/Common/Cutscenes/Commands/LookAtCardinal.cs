namespace Common.Cutscenes.Commands
{
    ...
    public sealed class LookAt : ICinematicCommand
    {
        ...
        public void Execute()
        {
            if (m_Character == null || m_Character.View == null || m_Target == null)
            {
                Debug.LogWarning("LookAt skipped because its character, view, or target is missing.");
                return;
            }

            m_Character.View.LookAtPosition(m_Target.position);
        }
