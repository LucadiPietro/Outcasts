...
public class DialogueExample : MonoBehaviour
{
	private void Start() {
		...
		DialogueController.instance.NewDialogueInstance("This is an [NAMES]easy to use package[/NAMES] to give developers a good looking and simple dialogue system.", "character_don"); 
	}
}
