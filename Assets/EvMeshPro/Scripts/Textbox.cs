...
public class Textbox : MonoBehaviour
{
    ...
    public void InitializeTextbox(string dialogue, Speaker speaker, Speaker.Emotion emotion)
    {
        audioSource = GetComponent<AudioSource>();
        this.dialogue = dialogue;
        ...
        {
            if (nameText != null) nameText.text = speaker.Name;
            if (nameTextImage != null)
            {
            ...
            if (characterSpriteImage != null) characterSpriteImage.sprite = emotion.Image;
        }
        else
        {
            if (nameText != null) nameText.text = "";
            if (nameTextImage != null) nameTextImage.enabled = false;
            if (characterSpriteBackground != null) characterSpriteBackground.gameObject.SetActive(false);
        }
    }
