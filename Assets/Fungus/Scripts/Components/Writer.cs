...
namespace Fungus
{
    ...
    public class Writer : MonoBehaviour, IDialogInputListener
    {
        ...
        protected virtual IEnumerator ProcessTokens(List<TextTagToken> tokens, bool stopAudio, System.Action onComplete, float customWritingSpeed)
        {
            ...
            currentWritingSpeed = customWritingSpeed > 0 ? customWritingSpeed : writingSpeed;
        ...
        public virtual IEnumerator Write(string content, bool clear, bool waitForInput, bool stopAudio, bool waitForVO, AudioClip audioClip, System.Action onComplete, float writingSpeed)
        {
            if (clear)
            {
                textAdapter.Text = "";
            ...
            yield return StartCoroutine(ProcessTokens(tokens, stopAudio, onComplete, writingSpeed));
        }
