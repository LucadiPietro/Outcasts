...
namespace Fungus.EditorUtils
{
    ...
    public class CharacterEditor : Editor
    {
        ...
        protected SerializedProperty writingSpeed;
        ...
        protected virtual void OnEnable()
        {
            ...
            writingSpeed = serializedObject.FindProperty("writingSpeed");
        ...
        public override void OnInspectorGUI() 
        {
            ...
            EditorGUILayout.PropertyField(writingSpeed, new GUIContent("Writing Speed", "Characters per second to be written, if == 0, default speed is used"));
